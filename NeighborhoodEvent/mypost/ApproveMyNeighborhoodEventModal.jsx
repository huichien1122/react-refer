...
class ApproveMyNeighborhoodEventModal extends Component{
  constructor(){
    super();
    this.state = {
      viewProfileData:"",
  ...
  getProfile = async() => {
    ...
    try{
      const ret = await GetProfile(data);
      //console.log(ret.data)
      if(ret.data.statusCode === 200){
        let txt = "";
    ...
    return (
      <>
        ...
        >
          ...
          <Row align="middle">
            <Col span={8}>
            <span><b>Total Price (RM) </b></span>
            </Col>
            <Col span={16}>
            <span>{approveData.total_price}</span>
            </Col>
          </Row>
          <br />
          ...
          <Row>
            ...
            <Button type="primary" onClick={()=>this.props.complete()} >Completed & Paid</Button>
            <Button type="primary" onClick={()=>this.props.incomplete()} >Incompleted & Unpaid </Button>
            </Col>
          </Row>
          <br />
          <Row>
...
export default  ApproveMyNeighborhoodEventModal;