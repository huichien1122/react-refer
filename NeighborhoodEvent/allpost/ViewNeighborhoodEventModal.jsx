import { Modal, Row, Col, Spin, Button, Image, Carousel, Avatar, message } from 'antd';
...
class ViewNeighborhoodEventModal extends Component{
  constructor(){
    super();
    this.state = {
      viewProfileData:"",
  ...
  getProfile = async() => {
    const data = {
      resident_id: this.props.viewData.provider_id,
    }
    try{
    ...
    return (
      <>
        ...
        >
          ...
          <Row align="middle">
            <Col span={24}>
              <Avatar src={<Image src={viewData.provider_avatar} style={{ width: 32, height: 32 }}
                fallback="data:image/png;base64,"
              />} />&nbsp;&nbsp;
              <b className='p_size_large' onClick={()=>this.viewOthersProfileModal()}>{viewData.provider_email} ({viewData.provider_detailed_address})</b>
            </Col>
          </Row>
          <br />
          <Row align="middle">
...
export default ViewNeighborhoodEventModal;